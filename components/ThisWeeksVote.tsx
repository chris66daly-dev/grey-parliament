  ...
  return (
    <section style={{ background: '#f5f3ee', padding: '4rem 1.5rem', borderBottom: '1px solid #c8c4bc' }}>
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        ...
        {question && (
          <Link href={`/vote/${question.id}`} style={{ display: 'inline-block', background: '#1a1814', color: '#f5f3ee', padding: '12px 24px', borderRadius: 8, fontSize: 15, fontWeight: 600, textDecoration: 'none', fontFamily: 'var(--sans)' }}>
            Cast your verdict →
          </Link>
        )}
      </div>
